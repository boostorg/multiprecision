#ifndef CRYPTO3_MP_MONTGOMERY_INT_IMPORT_EXPORT_HPP
#define CRYPTO3_MP_MONTGOMERY_INT_IMPORT_EXPORT_HPP
    ...
    namespace multiprecision {
        ...
        namespace detail {
            ...
            inline typename boost::disable_if_c<backends::is_trivial_cpp_int<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>>::value,
                    montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend> &>::type eval_import_bits_fast(montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend> &val, T *i, T *j, unsigned chunk_size = 0) {
            ...
            number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> &import_bits_generic(
                    number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                            ExpressionTemplates> &val, Iterator i, Iterator j, unsigned chunk_size = 0,
                    bool msv_first = true) {
            ...
            ::type import_bits_fast(number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> &val, T *i, T *j, unsigned chunk_size = 0) {
                std::size_t byte_len = (j - i) * (chunk_size ? chunk_size / CHAR_BIT : sizeof(*i));
                std::size_t limb_len = byte_len / sizeof(limb_type);
                if (byte_len % sizeof(limb_type)) {
                    ++limb_len;
...
#pragma warning(pop)
        ...
        inline number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> &import_bits(
                number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                        ExpressionTemplates> &val, Iterator i, Iterator j, unsigned chunk_size = 0,
                bool msv_first = true) {
        ...
        inline number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> &import_bits(
                number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                        ExpressionTemplates> &val, T *i, T *j, unsigned chunk_size = 0, bool msv_first = true) {
#ifdef BOOST_LITTLE_ENDIAN
            if (((chunk_size % CHAR_BIT) == 0) && !msv_first) {
        ...
        OutputIterator export_bits(const number<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> &val, OutputIterator out, unsigned chunk_size, bool msv_first = true) {
#ifdef _MSC_VER
#pragma warning(push)
#pragma warning(disable:4244)
#endif
...
#endif // CRYPTO3_MP_MONTGOMERY_INT_IMPORT_EXPORT_HPP
