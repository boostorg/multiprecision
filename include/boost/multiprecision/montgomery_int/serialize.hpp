...
namespace boost {
    ...
    namespace serialization {
        ...
        namespace montgomery_int_detail {
...
//
        ...
        template<
                typename Archive, unsigned MinBits, unsigned MaxBits, mp::cpp_integer_type SignType, mp::cpp_int_check_type Checked,
                class Allocator, typename ParamsBackend>
        void serialize(Archive &ar, mp::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend> &val,
                       const unsigned int /*version*/) {

            typedef typename Archive::is_saving save_tag;
            typedef mpl::bool_<mp::backends::is_trivial_cpp_int<
                    mp::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend> >::value> trivial_tag;
            typedef typename montgomery_int_detail::is_binary_archive<Archive>::type binary_tag;

            // Just dispatch to the correct method:
            montgomery_int_detail::do_serialize(ar, val, save_tag(), trivial_tag(), binary_tag());
        }
