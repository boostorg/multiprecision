...
#pragma warning(disable:4307)
        ...
        inline boost::multiprecision::number<
                ...
                ExpressionTemplates> get_min(const boost::mpl::true_ &, const boost::mpl::true_ &) {
            // Bounded and signed.
            typedef boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> result_type;
        ...
        inline boost::multiprecision::number<
                boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> get_min(const boost::mpl::true_ &, const boost::mpl::false_ &) {
            // Bounded and unsigned:
            static const boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> val(0u);
            return val;
        }
        ...
        inline boost::multiprecision::number<
                boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> get_min(const boost::mpl::false_ &, const boost::mpl::true_ &) {
        ...
        inline boost::multiprecision::number<
                boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> get_min(const boost::mpl::false_ &, const boost::mpl::false_ &) {
        ...
        inline boost::multiprecision::number<
                boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> get_max(const boost::mpl::true_ &, const boost::mpl::true_ &) {
            // Bounded and signed.
            typedef boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> result_type;
        ...
        inline boost::multiprecision::number<
                boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> get_max(const boost::mpl::true_ &, const boost::mpl::false_ &) {
            // Bound and unsigned:
            typedef boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> result_type;
        ...
        inline boost::multiprecision::number<
                boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> get_max(const boost::mpl::false_ &, const boost::mpl::true_ &) {
            // Unbounded and signed.
        ...
        inline boost::multiprecision::number<
                boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                ExpressionTemplates> get_max(const boost::mpl::false_ &, const boost::mpl::false_ &) {
            // Unbound and unsigned:
            static const boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> val(0u);
    ...
    template<unsigned MinBits, unsigned MaxBits, boost::multiprecision::cpp_integer_type SignType, boost::multiprecision::cpp_int_check_type Checked,
            class Allocator, typename ParamsBackend, boost::multiprecision::expression_template_option ExpressionTemplates> const typename numeric_limits<
            boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
                    ExpressionTemplates> >::inititializer numeric_limits<boost::multiprecision::number<
            boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
    ...
    template<unsigned MinBits, unsigned MaxBits, boost::multiprecision::cpp_integer_type SignType, boost::multiprecision::cpp_int_check_type Checked,
            class Allocator, typename ParamsBackend, boost::multiprecision::expression_template_option ExpressionTemplates> BOOST_CONSTEXPR_OR_CONST int numeric_limits<
            boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
    ...
    template<unsigned MinBits, unsigned MaxBits, boost::multiprecision::cpp_integer_type SignType, boost::multiprecision::cpp_int_check_type Checked,
            class Allocator, typename ParamsBackend, boost::multiprecision::expression_template_option ExpressionTemplates> BOOST_CONSTEXPR_OR_CONST bool numeric_limits<
            boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
    ...
    template<unsigned MinBits, unsigned MaxBits, boost::multiprecision::cpp_integer_type SignType, boost::multiprecision::cpp_int_check_type Checked,
            class Allocator, typename ParamsBackend, boost::multiprecision::expression_template_option ExpressionTemplates> BOOST_CONSTEXPR_OR_CONST float_denorm_style
    ...
    template<unsigned MinBits, unsigned MaxBits, boost::multiprecision::cpp_integer_type SignType, boost::multiprecision::cpp_int_check_type Checked,
            class Allocator, typename ParamsBackend, boost::multiprecision::expression_template_option ExpressionTemplates> BOOST_CONSTEXPR_OR_CONST float_round_style
            numeric_limits<boost::multiprecision::number<
                    boost::multiprecision::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,Allocator, ParamsBackend>,
