...
template <unsigned MinBits = 0, unsigned MaxBits = 0,
          ...
          typename ParamsBackend = cpp_int>
...
template <unsigned MinBits, unsigned MaxBits,
          ...
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct is_byte_container<backends::montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>>
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct max_precision<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,
                                            Allocator, ParamsBackend>> {
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct min_precision<montgomery_int_backend<MinBits, MaxBits, SignType, Checked,
                                            Allocator, ParamsBackend>> {
  static const unsigned value =
...
//
template <class T> struct is_trivial_montgomery_int {
  static const bool value = false;
};

template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct is_trivial_montgomery_int<montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>> {
  typedef montgomery_int_backend<MinBits, MaxBits, SignType, Checked, Allocator,
                                 ParamsBackend>
      self;
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct is_trivial_montgomery_int<montgomery_int_base<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend, true>> {
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct is_unsigned_number<backends::montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>>
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType>
struct is_non_throwing_montgomery_int<
    montgomery_int_backend<MinBits, MaxBits, SignType, unchecked, void>>
    : public mpl::true_ {};
...
//
template <class T> struct is_equal_montgomery_int_backend {
  constexpr static const bool value = false;
};

template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct is_equal_montgomery_int_backend<montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>> {
...
template <class T> struct is_equal_montgomery_int_field {
  constexpr static const bool value = false;
};

template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct is_equal_montgomery_int_field<montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>> {
  constexpr static const bool value = true;
};
...
template <class T, class U> struct is_implicit_cpp_int_conversion {
  constexpr static const bool value =
      (is_signed_number<T>::value || !is_signed_number<U>::value) &&
      (!std::is_constructible<std::tuple<double, double>, T>::value &&
       !std::is_constructible<std::tuple<double, double>, U>::value) &&
      (!std::is_constructible<std::tuple<float, float>, T>::value &&
       !std::is_constructible<std::tuple<float, float>, U>::value);
};
...
struct is_implicit_cpp_int_conversion<
    montgomery_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1,
                           ParamsBackend1>,
    montgomery_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2,
                           ParamsBackend2>> {
  typedef montgomery_int_backend<MinBits1, MaxBits1, SignType1, Checked1,
                                 Allocator1, ParamsBackend1>
      t1;
  typedef montgomery_int_backend<MinBits2, MaxBits2, SignType2, Checked2,
...
template<unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType>
struct is_non_throwing_cpp_int<montgomery_int_backend<MinBits, MaxBits,
SignType, unchecked, void> > : public mpl::true_ {
};
*/
//
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct is_fixed_precision<montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>>
    : public mpl::bool_<max_precision<montgomery_int_backend<
                            MinBits, MaxBits, SignType, Checked, Allocator,
                            ParamsBackend>>::value != UINT_MAX> {};

namespace detail {

// inline void verify_new_size(unsigned new_size, unsigned min_size, const
// mpl::int_<checked> &) {
//    if (new_size < min_size)
//        BOOST_THROW_EXCEPTION(std::overflow_error(
//                "Unable to allocate sufficient storage for the value of the
...
//    overflow error: if (b && (limb & ~mask))
//        BOOST_THROW_EXCEPTION(std::overflow_error(
//                "Overflow in cpp_int arithmetic: there is insufficient
//                precision in the target type to hold all of the bits of the
//                result."));
//}

// template<class U>
// inline void verify_limb_mask(bool /*b*/, U /*limb*/, U /*mask*/, const
// mpl::int_<unchecked> &) {
//}
...
struct montgomery_int_base<MinBits, MaxBits, signed_magnitude, Checked,
                           Allocator, ParamsBackend, false>
...
public:
  ...
  BOOST_STATIC_CONSTANT(
      unsigned,
      internal_limb_count = MinBits ? (MinBits / limb_bits +
...
public:
  ...
  // Direct construction:
  //
  BOOST_MP_FORCEINLINE BOOST_CONSTEXPR montgomery_int_base(limb_type i)
      BOOST_NOEXCEPT : m_data(i),
                       m_limbs(1),
                       m_sign(false),
                       m_internal(true) {}

  BOOST_MP_FORCEINLINE BOOST_CONSTEXPR montgomery_int_base(signed_limb_type i)
      BOOST_NOEXCEPT : m_data(i),
                       m_limbs(1),
                       m_sign(i < 0),
                       m_internal(true) {}
  ...
  BOOST_MP_FORCEINLINE BOOST_CONSTEXPR montgomery_int_base(double_limb_type i)
      BOOST_NOEXCEPT : m_data(i),
  ...
  montgomery_int_base(signed_double_limb_type i) BOOST_NOEXCEPT
      : m_data(i),
...
template <unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
          class Allocator, typename ParamsBackend>
const unsigned montgomery_int_base<MinBits, MaxBits, signed_magnitude, Checked,
                                   Allocator, ParamsBackend, false>::limb_bits;
template <unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
          class Allocator, typename ParamsBackend>
const limb_type
    montgomery_int_base<MinBits, MaxBits, signed_magnitude, Checked, Allocator,
                        ParamsBackend, false>::max_limb_value;
template <unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
          class Allocator, typename ParamsBackend>
const limb_type
    montgomery_int_base<MinBits, MaxBits, signed_magnitude, Checked, Allocator,
                        ParamsBackend, false>::sign_bit_mask;
template <unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
          class Allocator, typename ParamsBackend>
const unsigned
    montgomery_int_base<MinBits, MaxBits, signed_magnitude, Checked, Allocator,
                        ParamsBackend, false>::internal_limb_count;
template <unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
          class Allocator, typename ParamsBackend>
const bool montgomery_int_base<MinBits, MaxBits, signed_magnitude, Checked,
...
template <unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
          class Allocator, typename ParamsBackend>
struct montgomery_int_base<MinBits, MaxBits, unsigned_magnitude, Checked,
                           Allocator, ParamsBackend, false>
    : private Allocator::template rebind<limb_type>::other {
  //
...
public:
  ...
  BOOST_MP_FORCEINLINE void normalize()
      BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) {
    limb_pointer p = limbs();
...
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const unsigned montgomery_int_base<MinBits, MinBits, signed_magnitude, Checked,
                                   void, ParamsBackend, false>::limb_bits;
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const limb_type montgomery_int_base<MinBits, MinBits, signed_magnitude, Checked,
                                    void, ParamsBackend, false>::max_limb_value;
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const limb_type montgomery_int_base<MinBits, MinBits, signed_magnitude, Checked,
                                    void, ParamsBackend, false>::sign_bit_mask;
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const unsigned
    montgomery_int_base<MinBits, MinBits, signed_magnitude, Checked, void,
                        ParamsBackend, false>::internal_limb_count;
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const bool montgomery_int_base<MinBits, MinBits, signed_magnitude, Checked,
                               void, ParamsBackend, false>::variable;
...
public:
  ...
  BOOST_MP_FORCEINLINE montgomery_int_base(signed_limb_type i)
      BOOST_MP_NOEXCEPT_IF((Checked == unchecked))
      : m_wrapper(limb_type(i < 0
                                ? static_cast<limb_type>(
                                      -static_cast<signed_double_limb_type>(i))
  ...
  BOOST_MP_FORCEINLINE montgomery_int_base(signed_double_limb_type i)
      BOOST_MP_NOEXCEPT_IF((Checked == unchecked))
      : m_wrapper(double_limb_type(
            i < 0 ? static_cast<double_limb_type>(
                        boost::multiprecision::detail::unsigned_abs(i))
  ...
  BOOST_CONSTEXPR montgomery_int_base(literals::detail::value_pack<>)
  ...
  BOOST_MP_FORCEINLINE void sign(bool b)
      BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) {
    if (b) {
      negate();
    }
...
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const unsigned
    montgomery_int_base<MinBits, MinBits, unsigned_magnitude, Checked, void,
                        ParamsBackend, false>::limb_bits;
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const limb_type
    montgomery_int_base<MinBits, MinBits, unsigned_magnitude, Checked, void,
                        ParamsBackend, false>::max_limb_value;
...
const unsigned
    montgomery_int_base<MinBits, MinBits, unsigned_magnitude, Checked, void,
                        ParamsBackend, false>::internal_limb_count;
template <unsigned MinBits, cpp_int_check_type Checked, typename ParamsBackend>
const bool montgomery_int_base<MinBits, MinBits, unsigned_magnitude, Checked,
                               void, ParamsBackend, false>::variable;
...
template<unsigned N>
struct trivial_limb_type : public trivial_limb_type_imp<N, N <=
...
protected:
  ...
  void check_in_range(T val) BOOST_MP_NOEXCEPT_IF(noexcept(
      std::declval<montgomery_int_base>().check_in_range(std::declval<T>(),
                                                         checked_type()))) {
...
public:
  ...
  BOOST_CONSTEXPR
  montgomery_int_base(literals::detail::value_pack<>) BOOST_NOEXCEPT
      : m_data(static_cast<local_limb_type>(0u)),
        m_sign(false) {}

  template <limb_type a>
  BOOST_CONSTEXPR
  montgomery_int_base(literals::detail::value_pack<a>) BOOST_NOEXCEPT
      : m_data(static_cast<local_limb_type>(a)),
        m_sign(false) {}

  template <limb_type a, limb_type b>
  BOOST_CONSTEXPR
  montgomery_int_base(literals::detail::value_pack<a, b>) BOOST_NOEXCEPT
      : m_data(static_cast<local_limb_type>(a) |
...
protected:
  ...
  BOOST_MP_FORCEINLINE void check_in_range(T val) BOOST_MP_NOEXCEPT_IF(
      noexcept(std::declval<montgomery_int_base>().check_in_range(
...
public:
  ...
  BOOST_MP_FORCEINLINE void negate()
      BOOST_MP_NOEXCEPT_IF((Checked == unchecked)) {
    if (Checked == checked) {
      BOOST_THROW_EXCEPTION(
...
struct is_allowed_montgomery_int_base_conversion
...
#endif
                           || (is_trivial_montgomery_int<Base>::value &&
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct montgomery_int_backend
    : public montgomery_int_base<
          min_precision<
              montgomery_int_backend<MinBits, MaxBits, SignType, Checked,
                                     Allocator, ParamsBackend>>::value,
          max_precision<
              montgomery_int_backend<MinBits, MaxBits, SignType, Checked,
                                     Allocator, ParamsBackend>>::value,
          SignType, Checked, Allocator, ParamsBackend,
  ...
  typedef montgomery_int_backend<MinBits, MaxBits, SignType, Checked, Allocator,
                                 ParamsBackend>
      self_type;
  typedef montgomery_int_base<min_precision<self_type>::value,
                              max_precision<self_type>::value, SignType,
                              Checked, Allocator, ParamsBackend,
                              is_trivial_montgomery_int<self_type>::value>
      base_type;
  ...
  void do_assign(
    ...
    *this = static_cast<typename boost::multiprecision::detail::canonical<
        ...
        montgomery_int_backend<MinBits, MaxBits, SignType, Checked, Allocator,
                               ParamsBackend>>::type>(*other.limbs());
    this->sign(other.sign());
  }
...
public:
  ...
  montgomery_int_backend(
    ...
    do_assign(
        ...
        mpl::bool_<is_trivial_montgomery_int<montgomery_int_backend<
...
private:
  ...
  void do_assign_arithmetic(signed_double_limb_type i, const mpl::false_ &)
    ...
    ui = static_cast<double_limb_type>(
        boost::multiprecision::detail::unsigned_abs(i));
    typename base_type::limb_pointer p = this->limbs();
#ifdef __MSVC_RUNTIME_CHECKS
...
public:
  ...
  BOOST_MP_FORCEINLINE
      typename enable_if_c<is_equal_montgomery_int_backend<
                               Backend<MinBits2, MaxBits2, SignType2, Checked2,
  ...
  BOOST_MP_FORCEINLINE
      ...
      // template<unsigned MinBits2, unsigned MaxBits2, cpp_integer_type
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct double_precision_type<backends::montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>> {
  typedef typename mpl::if_c<
      backends::is_fixed_precision<
          backends::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,
                                           Allocator, ParamsBackend>>::value,
      backends::montgomery_int_backend<
          (is_void<Allocator>::value
               ? 2 * backends::max_precision<backends::montgomery_int_backend<
          ...
          SignType, Checked, Allocator, ParamsBackend>,
      backends::montgomery_int_backend<MinBits, MaxBits, SignType, Checked,
                                       Allocator, ParamsBackend>>::type type;
};

} // namespace default_ops

template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, typename ParamsBackend>
struct expression_template_default<backends::montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, void, ParamsBackend>> {
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
struct number_category<montgomery_int_backend<
    MinBits, MaxBits, SignType, Checked, Allocator, ParamsBackend>>
...
typedef number<
    montgomery_int_backend<128, 128, unsigned_magnitude, unchecked, void>>
    umontgomery128_t;
typedef number<
    montgomery_int_backend<256, 256, unsigned_magnitude, unchecked, void>>
    umontgomery256_t;
typedef number<
    montgomery_int_backend<512, 512, unsigned_magnitude, unchecked, void>>
    umontgomery512_t;
typedef number<
    montgomery_int_backend<1024, 1024, unsigned_magnitude, unchecked, void>>
    umontgomery1024_t;

// Fixed precision signed types:
typedef number<
    montgomery_int_backend<128, 128, signed_magnitude, unchecked, void>>
    montgomery128_t;
typedef number<
    montgomery_int_backend<256, 256, signed_magnitude, unchecked, void>>
    montgomery256_t;
typedef number<
    montgomery_int_backend<512, 512, signed_magnitude, unchecked, void>>
    montgomery512_t;
typedef number<
    montgomery_int_backend<1024, 1024, signed_magnitude, unchecked, void>>
    montgomery1024_t;

// Over again, but with checking enabled this time:
typedef number<montgomery_int_backend<0, 0, signed_magnitude, checked>>
    checked_montgomery_int;
typedef rational_adaptor<
    montgomery_int_backend<0, 0, signed_magnitude, checked>>
    checked_montgomery_rational_backend;
typedef number<checked_cpp_rational_backend> checked_cpp_rational;
// Fixed precision unsigned types:
typedef number<
    montgomery_int_backend<128, 128, unsigned_magnitude, checked, void>>
    checked_umontgomery128_t;
typedef number<
    montgomery_int_backend<256, 256, unsigned_magnitude, checked, void>>
    checked_umontgomery256_t;
typedef number<
    montgomery_int_backend<512, 512, unsigned_magnitude, checked, void>>
    checked_umontgomery512_t;
typedef number<
    montgomery_int_backend<1024, 1024, unsigned_magnitude, checked, void>>
    checked_umontgomery1024_t;

// Fixed precision signed types:
typedef number<
    montgomery_int_backend<128, 128, signed_magnitude, checked, void>>
    checked_montgomery128_t;
typedef number<
    montgomery_int_backend<256, 256, signed_magnitude, checked, void>>
    checked_montgomery256_t;
typedef number<
    montgomery_int_backend<512, 512, signed_magnitude, checked, void>>
    checked_montgomery512_t;
typedef number<
    montgomery_int_backend<1024, 1024, signed_magnitude, checked, void>>
    checked_montgomery1024_t;
...
template <unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
          ...
          cpp_int_check_type Checked2, class Allocator2, typename ParamsBackend>
struct is_explicitly_convertible<
    montgomery_int_backend<MinBits, MaxBits, SignType, Checked, Allocator,
                           ParamsBackend>,
    montgomery_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2,
                           ParamsBackend2>> : public mpl::true_ {};
...
struct component_type<number<boost::multiprecision::montgomery_int_backend<>,
                             ExpressionTemplates>> {
