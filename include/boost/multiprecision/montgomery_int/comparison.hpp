...
template <template <unsigned, unsigned, cpp_integer_type, cpp_int_check_type,
                    typename, typename>
          class Backend,
          unsigned MinBits, unsigned MaxBits, cpp_integer_type SignType,
...
/*!template<template<unsigned, unsigned, cpp_integer_type, cpp_int_check_type,
typename, typename> class Backend, unsigned MinBits, unsigned MaxBits,
cpp_int_check_type Checked, class Allocator, typename ParamsBackend>
BOOST_MP_FORCEINLINE typename enable_if_c<is_trivial_montgomery_int<
        Backend<MinBits, MaxBits, signed_magnitude, Checked, void> >::value,
bool>

::value eval_eq(const montgomery_int_backend<MinBits, MaxBits, signed_magnitude,
Checked, void> &a, const montgomery_int_backend<MinBits, MaxBits,
signed_magnitude, Checked, void> &b) BOOST_NOEXCEPT { return (a.sign() ==
b.sign()) && (*a.limbs() == *b.limbs());
}*/
...
template <template <unsigned, unsigned, cpp_integer_type, cpp_int_check_type,
                    typename, typename>
          class Backend,
          unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
...
template <unsigned MinBits, unsigned MaxBits, cpp_int_check_type Checked,
          typename ParamsBackend, class U>
BOOST_MP_FORCEINLINE
