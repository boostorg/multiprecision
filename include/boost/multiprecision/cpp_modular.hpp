...
//mnt params
typedef number<montgomery_params<cpp_int_backend<> > >          cpp_mod_params;

// Fixed precision unsigned types:
typedef number<montgomery_params<cpp_int_backend<128, 128, unsigned_magnitude, unchecked, void> > >   umod_params_params128_t;
typedef number<montgomery_params<cpp_int_backend<256, 256, unsigned_magnitude, unchecked, void> > >   umod_params256_t;
typedef number<montgomery_params<cpp_int_backend<512, 512, unsigned_magnitude, unchecked, void> > >   umod_params512_t;
typedef number<montgomery_params<cpp_int_backend<1024, 1024, unsigned_magnitude, unchecked, void> > > umod_params1024_t;

// Fixed precision signed types:
typedef  number<montgomery_params<cpp_int_backend<128, 128, signed_magnitude, unchecked, void> > >   mod_params128_t;
typedef  number<montgomery_params<cpp_int_backend<256, 256, signed_magnitude, unchecked, void> > >   mod_params256_t;
typedef  number<montgomery_params<cpp_int_backend<512, 512, signed_magnitude, unchecked, void> > >   mod_params512_t;
typedef  number<montgomery_params<cpp_int_backend<1024, 1024, signed_magnitude, unchecked, void> > > mod_params1024_t;

// Over again, but with checking enabled this time:
typedef  number<montgomery_params<cpp_int_backend<0, 0, signed_magnitude, checked> > >               checked_cpp_mod_params;

// Fixed precision unsigned types:
typedef  number<montgomery_params<cpp_int_backend<128, 128, unsigned_magnitude, checked, void> > >   checked_umod_params128_t;
typedef  number<montgomery_params<cpp_int_backend<256, 256, unsigned_magnitude, checked, void> > >   checked_umod_params256_t;
typedef  number<montgomery_params<cpp_int_backend<512, 512, unsigned_magnitude, checked, void> > >   checked_umod_params512_t;
typedef  number<montgomery_params<cpp_int_backend<1024, 1024, unsigned_magnitude, checked, void> > > checked_umod_params1024_t;

// Fixed precision signed types:
typedef  number<montgomery_params<cpp_int_backend<128, 128, signed_magnitude, checked, void> > >   checked_mod_params128_t;
typedef  number<montgomery_params<cpp_int_backend<256, 256, signed_magnitude, checked, void> > >   checked_mod_params256_t;
typedef  number<montgomery_params<cpp_int_backend<512, 512, signed_magnitude, checked, void> > >   checked_mod_params512_t;
typedef  number<montgomery_params<cpp_int_backend<1024, 1024, signed_magnitude, checked, void> > > checked_mod_params1024_t;
