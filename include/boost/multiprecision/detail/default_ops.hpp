...
template <class T, class V>
inline typename enable_if_c<is_convertible<V, number<T, et_on>>::value &&
...
template <class T> inline void eval_add_default(T &t, const T &u, const T &v) {
  if (&t == &v) {
    eval_add(t, u);
  } else if (&t == &u) {
    eval_add(t, v);
...
inline typename boost::enable_if_c<boost::is_integral<R>::value, bool>::type
...
inline typename boost::enable_if_c<boost::is_integral<R>::value>::type
...
template <class R, class B>
inline typename boost::disable_if_c<boost::is_integral<R>::value>::type
eval_convert_to(R *result, const B &backend) {
  typedef typename calculate_next_larger_type<R, B>::type next_type;
  next_type n;
  eval_convert_to(&n, backend);
...
template <class B>
inline void eval_convert_to(std::complex<long double> *result,
                            const B &backend) {
  typedef typename scalar_result_from_possible_complex<
      multiprecision::number<B>>::type scalar_type;
  scalar_type re, im;
...
// Functions:
//
template <class T> void eval_abs(T &result, const T &arg) {
...
template <class T> void eval_fabs(T &result, const T &arg) {
...
template <class Backend> inline int eval_fpclassify(const Backend &arg) {
  BOOST_STATIC_ASSERT_MSG(
...
template <class T> inline void eval_fmod(T &result, const T &a, const T &b) {
  BOOST_STATIC_ASSERT_MSG(
      number_category<T>::value == number_kind_floating_point,
...
template <class T> void eval_round(T &result, const T &a);
...
template <class B> bool eval_gt(const B &a, const B &b);
template <class T, class U> bool eval_gt(const T &a, const U &b);
template <class B> bool eval_lt(const B &a, const B &b);
template <class T, class U> bool eval_lt(const T &a, const U &b);

template <class T> inline void eval_fdim(T &result, const T &a, const T &b) {
...
template <class T, class A>
inline typename boost::enable_if_c<boost::is_arithmetic<A>::value>::type
...
template <class T> inline void eval_trunc(T &result, const T &a) {
  BOOST_STATIC_ASSERT_MSG(
      number_category<T>::value == number_kind_floating_point,
...
template <class T> inline void eval_modf(T &result, T const &arg, T *pipart) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
...
template <class T> inline void eval_round(T &result, const T &a) {
  BOOST_STATIC_ASSERT_MSG(
      number_category<T>::value == number_kind_floating_point,
...
template <class B> void eval_lcm(B &result, const B &a, const B &b);
template <class B> void eval_gcd(B &result, const B &a, const B &b);
...
template <class T> inline unsigned eval_lsb(const T &val) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
...
template <class T> inline int eval_msb(const T &val) {
  int c = eval_get_sign(val);
  if (c == 0) {
    BOOST_THROW_EXCEPTION(std::range_error("No bits were set in the operand."));
  }
...
template <class T> inline bool eval_bit_test(const T &val, unsigned index) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
  T mask, t;
  mask = ui_type(1);
...
template <class T> inline void eval_bit_set(T &val, unsigned index) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
  T mask;
  mask = ui_type(1);
...
template <class T> inline void eval_bit_flip(T &val, unsigned index) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
  T mask;
  mask = ui_type(1);
...
template <class T> inline void eval_bit_unset(T &val, unsigned index) {
  typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type
      ui_type;
  T mask, t;
  mask = ui_type(1);
...
template <class B> void eval_integer_sqrt(B &s, B &r, const B &x) {
  //
...
template <class B> inline void eval_conj(B &result, const B &val) {
  result = val; // assume non-complex result.
}
template <class B> inline void eval_proj(B &result, const B &val) {
  result = val; // assume non-complex result.
}
...
//
template <class B> inline typename B::exponent_type eval_ilogb(const B &val) {
  BOOST_STATIC_ASSERT_MSG(
...
template <class T> int eval_signbit(const T &val);

template <class B> inline void eval_logb(B &result, const B &val) {
  switch (eval_fpclassify(val)) {
  case FP_NAN:
    result = val;
    errno = EDOM;
...
template <class R, class T> inline void eval_nearbyint(R &result, const T &a) {
  eval_round(result, a);
}
template <class R, class T> inline void eval_rint(R &result, const T &a) {
  eval_nearbyint(result, a);
}

template <class T> inline int eval_signbit(const T &val) {
...
template <class To, class From> inline void eval_imag(To &to, const From &) {
...
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
inline bool isfinite BOOST_PREVENT_MACRO_SUBSTITUTION(
    const multiprecision::number<Backend, ExpressionTemplates> &arg) {
...
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
inline bool isinf BOOST_PREVENT_MACRO_SUBSTITUTION(
    const multiprecision::number<Backend, ExpressionTemplates> &arg) {
...
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
inline bool isnormal BOOST_PREVENT_MACRO_SUBSTITUTION(
    const multiprecision::number<Backend, ExpressionTemplates> &arg) {
...
template <class tag, class A1, class A2, class A3, class A4>
inline typename multiprecision::detail::expression<tag, A1, A2, A3,
...
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
inline long lrint BOOST_PREVENT_MACRO_SUBSTITUTION(
    const multiprecision::number<Backend, ExpressionTemplates> &arg) {
  return lround(arg);
}
template <class tag, class A1, class A2, class A3, class A4>
...
template <class Backend,
          multiprecision::expression_template_option ExpressionTemplates>
inline boost::long_long_type llrint BOOST_PREVENT_MACRO_SUBSTITUTION(
    const multiprecision::number<Backend, ExpressionTemplates> &arg) {
  return llround(arg);
}
template <class tag, class A1, class A2, class A3, class A4>
...
inline number<B1, ET1> &add(number<B1, ET1> &result, const number<B2, ET2> &a,
...
template <class B1, class B2, class B3, expression_template_option ET1,
          expression_template_option ET2, expression_template_option ET3>
inline number<B1, ET1> &subtract(number<B1, ET1> &result,
...
template <class B1, class B2, class B3, expression_template_option ET1,
          expression_template_option ET2, expression_template_option ET3>
inline number<B1, ET1> &multiply(number<B1, ET1> &result,
                                 const number<B2, ET2> &a,
                                 const number<B3, ET3> &b) {
  BOOST_STATIC_ASSERT_MSG(
      (is_convertible<B2, B1>::value),
...
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline number<T, ExpressionTemplates>
...
template <class Backend, class U>
inline typename enable_if_c<number_category<number<Backend, et_on>>::value ==
                                number_kind_floating_point,
                            number<Backend, et_off>>::type
...
#define UNARY_OP_FUNCTOR(func, category)                                       \
  ...
  struct BOOST_JOIN(category, BOOST_JOIN(func, _funct)) {                      \
    ...
    template <class U> void operator()(U &result, const Backend &arg) const {  \
      using default_ops::BOOST_JOIN(eval_, func);                              \
      Backend temp;                                                            \
  ...
  template <class tag, class A1, class A2, class A3, class A4>                 \
      inline typename enable_if_c<                                             \
          ...
          detail::expression<                                                  \
              detail::function,                                                \
              detail::BOOST_JOIN(category, BOOST_JOIN(func, _funct)) <         \
                  typename detail::backend_type<                               \
                      detail::expression<tag, A1, A2, A3, A4>>::type>,         \
          detail::expression<tag, A1, A2, A3, A4>>>                            \
      ::type func(const detail::expression<tag, A1, A2, A3, A4> &arg) {        \
  ...
  template <class Backend>                                                     \
      inline typename enable_if_c<                                             \
          ...
          detail::expression<detail::function,                                 \
                             detail::BOOST_JOIN(category,                      \
                                                BOOST_JOIN(func, _funct)) <    \
                                 Backend>,                                     \
          number<Backend, et_on>>>                                             \
      ::type func(const number<Backend, et_on> &arg) {                         \
...
#define BINARY_OP_FUNCTOR(func, category)                                      \
  ...
  template <class Backend>                                                     \
  struct BOOST_JOIN(category, BOOST_JOIN(func, _funct)) {                      \
    void operator()(Backend &result, const Backend &arg,                       \
                    const Backend &a) const {                                  \
      using default_ops::BOOST_JOIN(eval_, func);                              \
      BOOST_JOIN(eval_, func)(result, arg, a);                                 \
    }                                                                          \
    template <class Arithmetic>                                                \
    void operator()(Backend &result, const Backend &arg,                       \
                    const Arithmetic &a) const {                               \
      using default_ops::BOOST_JOIN(eval_, func);                              \
      BOOST_JOIN(eval_, func)                                                  \
      (result, arg, number<Backend>::canonical_value(a));                      \
    }                                                                          \
    template <class Arithmetic>                                                \
    void operator()(Backend &result, const Arithmetic &arg,                    \
                    const Backend &a) const {                                  \
      using default_ops::BOOST_JOIN(eval_, func);                              \
      BOOST_JOIN(eval_, func)                                                  \
    ...
    void operator()(U &result, const Backend &arg,                             \
                    const Arithmetic &a) const {                               \
      using default_ops::BOOST_JOIN(eval_, func);                              \
      Backend r;                                                               \
    ...
    template <class U, class Arithmetic>                                       \
    void operator()(U &result, const Arithmetic &arg,                          \
                    const Backend &a) const {                                  \
      using default_ops::BOOST_JOIN(eval_, func);                              \
      Backend r;                                                               \
      ...
      inline typename enable_if_c<                                             \
          ...
          detail::expression<detail::function,                                 \
                             detail::BOOST_JOIN(category,                      \
                                                BOOST_JOIN(func, _funct)) <    \
                                 Backend>,                                     \
          number<Backend, et_on>, number<Backend, et_on>>>                     \
      ::type func(const number<Backend, et_on> &arg,                           \
                  const number<Backend, et_on> &a) {                           \
    return detail::expression<detail::function,                                \
                              detail::BOOST_JOIN(category,                     \
                                                 BOOST_JOIN(func, _funct)) <   \
                                  Backend>,                                    \
  ...
  template <class Backend, class tag, class A1, class A2, class A3, class A4>  \
      inline typename enable_if_c<                                             \
          (number_category<Backend>::value == category) &&                     \
              (boost::is_convertible<typename detail::expression<              \
                                         tag, A1, A2, A3, A4>::result_type,    \
                                     number<Backend, et_on>>::value),          \
          detail::expression<detail::function,                                 \
                             detail::BOOST_JOIN(category,                      \
                                                BOOST_JOIN(func, _funct)) <    \
                                 Backend>,                                     \
          number<Backend, et_on>, detail::expression<tag, A1, A2, A3, A4>>>    \
      ::type func(const number<Backend, et_on> &arg,                           \
      ...
      inline typename enable_if_c<                                             \
          ...
          detail::expression<detail::function,                                 \
                             detail::BOOST_JOIN(category,                      \
                                                BOOST_JOIN(func, _funct)) <    \
                                 Backend>,                                     \
          detail::expression<tag, A1, A2, A3, A4>, number<Backend, et_on>>>    \
      ::type func(const detail::expression<tag, A1, A2, A3, A4> &arg,          \
                  const number<Backend, et_on> &a) {                           \
    return detail::expression<detail::function,                                \
                              detail::BOOST_JOIN(category,                     \
  ...
  template <class tag, class A1, class A2, class A3, class A4, class tagb,     \
      ...
      inline typename enable_if_c<                                             \
          (number_category<detail::expression<tag, A1, A2, A3, A4>>::value ==  \
           category) &&                                                        \
              (number_category<detail::expression<tagb, A1b, A2b, A3b,         \
                                                  A4b>>::value == category),   \
          detail::expression<                                                  \
              detail::function,                                                \
              detail::BOOST_JOIN(category, BOOST_JOIN(func, _funct)) <         \
  ...
  template <class Backend, class Arithmetic>                                   \
      inline typename enable_if_c<                                             \
          is_compatible_arithmetic_type<Arithmetic,                            \
                                        number<Backend, et_on>>::value &&      \
              (number_category<Backend>::value == category),                   \
          detail::expression<detail::function,                                 \
                             detail::BOOST_JOIN(category,                      \
                                                BOOST_JOIN(func, _funct)) <    \
                                 Backend>,                                     \
          number<Backend, et_on>, Arithmetic>>                                 \
      ::type func(const number<Backend, et_on> &arg, const Arithmetic &a) {    \
    return detail::expression<detail::function,                                \
                              detail::BOOST_JOIN(category,                     \
                                                 BOOST_JOIN(func, _funct)) <   \
                                  Backend>,                                    \
  ...
  template <class tag, class A1, class A2, class A3, class A4,                 \
      ...
      inline typename enable_if_c<                                             \
          is_compatible_arithmetic_type<                                       \
              Arithmetic, typename detail::expression<                         \
                              tag, A1, A2, A3, A4>::result_type>::value &&     \
              (number_category<detail::expression<tag, A1, A2, A3,             \
                                                  A4>>::value == category),    \
          detail::expression<                                                  \
              detail::function,                                                \
              detail::BOOST_JOIN(category, BOOST_JOIN(func, _funct)) <         \
                  typename detail::backend_type<                               \
                      detail::expression<tag, A1, A2, A3, A4>>::type>,         \
          detail::expression<tag, A1, A2, A3, A4>, Arithmetic>>                \
      ::type func(const detail::expression<tag, A1, A2, A3, A4> &arg,          \
                  const Arithmetic &a) {                                       \
    return detail::expression<                                                 \
               detail::function,                                               \
      ...
      inline typename enable_if_c<                                             \
          ...
          detail::expression<detail::function,                                 \
                             detail::BOOST_JOIN(category,                      \
                                                BOOST_JOIN(func, _funct)) <    \
                                 Backend>,                                     \
          Arithmetic, number<Backend, et_on>>>                                 \
      ::type func(const Arithmetic &arg, const number<Backend, et_on> &a) {    \
    return detail::expression<detail::function,                                \
                              detail::BOOST_JOIN(category,                     \
                                                 BOOST_JOIN(func, _funct)) <   \
                                  Backend>,                                    \
      ...
      inline typename enable_if_c<                                             \
          ...
          detail::expression<                                                  \
              ...
              detail::BOOST_JOIN(category, BOOST_JOIN(func, _funct)) <         \
                  typename detail::backend_type<                               \
                      detail::expression<tag, A1, A2, A3, A4>>::type>,         \
          Arithmetic, detail::expression<tag, A1, A2, A3, A4>>>                \
      ::type func(const Arithmetic &arg,                                       \
                  const detail::expression<tag, A1, A2, A3, A4> &a) {          \
    return detail::expression<                                                 \
               detail::function,                                               \
               detail::BOOST_JOIN(category, BOOST_JOIN(func, _funct)) <        \
  ...
  inline                                                                       \
      typename enable_if_c<is_compatible_arithmetic_type<                      \
                               Arithmetic, number<Backend, et_off>>::value &&  \
                               (number_category<Backend>::value == category),  \
                           number<Backend, et_off>>::type                      \
  ...
  inline                                                                       \
    ...
    using default_ops::BOOST_JOIN(eval_, func);                                \
    BOOST_JOIN(eval_, func)                                                    \
    (result.backend(), number<Backend, et_off>::canonical_value(a),            \
     arg.backend());                                                           \
    return BOOST_MP_MOVE(result);                                              \
  }
      ...
      inline typename enable_if_c<                                             \
          ...
          detail::expression<                                                  \
              ...
              detail::BOOST_JOIN(category, BOOST_JOIN(func, _funct)) <         \
                  typename detail::backend_type<                               \
                      detail::expression<tag, A1, A2, A3, A4>>::type>,         \
          detail::expression<tag, A1, A2, A3, A4>, Arg2>>                      \
      ::type func(const detail::expression<tag, A1, A2, A3, A4> &arg,          \
                  Arg2 const &a) {                                             \
    return detail::expression<                                                 \
               detail::function,                                               \
      ...
      inline typename enable_if_c<                                             \
          ...
          detail::expression<detail::function,                                 \
                             detail::BOOST_JOIN(category,                      \
                                                BOOST_JOIN(func, _funct)) <    \
                                 Backend>,                                     \
          number<Backend, et_on>, Arg2>>                                       \
      ::type func(const number<Backend, et_on> &arg, Arg2 const &a) {          \
    return detail::expression<detail::function,                                \
                              detail::BOOST_JOIN(category,                     \
                                                 BOOST_JOIN(func, _funct)) <   \
                                  Backend>,                                    \
           number<Backend, et_on>,                                             \
           Arg2 > (detail::BOOST_JOIN(category, BOOST_JOIN(func, _funct)) <    \
                       Backend > (),                                           \
                   arg, a);                                                    \
  }                                                                            \
  template <class Backend>                                                     \
...
template <class Backend>
inline typename disable_if_c<number_category<Backend>::value ==
                                 number_kind_complex,
                             number<Backend, et_off>>::type
...
template <class tag, class A1, class A2, class A3, class A4>
inline detail::expression<detail::function,
...
template <class Backend>
inline detail::expression<detail::function, detail::conj_funct<Backend>,
                          number<Backend, et_on>>
...
template <class Backend>
inline number<Backend, et_off> conj(const number<Backend, et_off> &arg) {
  detail::scoped_default_precision<multiprecision::number<Backend, et_off>>
      precision_guard(arg);
  number<Backend, et_off> result;
  using default_ops::eval_conj;
...
template <class Backend>
inline detail::expression<detail::function, detail::proj_funct<Backend>,
                          number<Backend, et_on>>
...
template <class Backend>
inline number<Backend, et_off> proj(const number<Backend, et_off> &arg) {
  detail::scoped_default_precision<multiprecision::number<Backend, et_off>>
      precision_guard(arg);
  number<Backend, et_off> result;
  using default_ops::eval_proj;
