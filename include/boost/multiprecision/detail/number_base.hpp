...
#define BOOST_MP_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS
  ...
  || (defined( __APPLE_CC__) && (__clang_major__ <= 9)) || (defined(__clang_major__) && (__clang_major__ < 6))
...
template <class T>
inline BOOST_MP_CXX14_CONSTEXPR void swap(T&a, T& b)
{
   T t(b);
   b = a;
   a = t;
...
inline BOOST_MP_CXX14_CONSTEXPR OutputIterator copy(InputIterator first, InputIterator last, OutputIterator result)
{
...
inline BOOST_MP_CXX14_CONSTEXPR bool equal(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2)
{
...
struct expression<terminal, Arg1, void, void, void>
{
   ...
   BOOST_MP_CXX14_CONSTEXPR const Arg1& value()const BOOST_NOEXCEPT { return arg; }
