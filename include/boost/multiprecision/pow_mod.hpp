...
*/
        ...
        public:
            ...
            enum usage_hints {
                ...
                BASE_IS_FIXED = 0x0001, BASE_IS_SMALL = 0x0002, BASE_IS_LARGE = 0x0004, BASE_IS_2 = 0x0008,

                EXP_IS_FIXED = 0x0100, EXP_IS_SMALL = 0x0200, EXP_IS_LARGE = 0x0400
            };
...
* representation. Likely only useful for testing.
*/
            power_mod(const cpp_int &modulus = 0, usage_hints hints = NO_HINTS, bool disable_montgomery_arith = false);
...
*/
        ...
        public:
            ...
            fixed_exponent_power_mod(const cpp_int &exponent, const cpp_int &modulus, usage_hints hints = NO_HINTS);
...
*/
        ...
        public:
            ...
            fixed_base_power_mod(const cpp_int &base, const cpp_int &modulus, usage_hints hints = NO_HINTS);
        ...
        inline Backend eval_power_mod(const Backend &base, const Backend &exp, const Backend &mod) {
        ...
        inline number<Backend, ExpressionTemplates> power_mod(const number<Backend, ExpressionTemplates> &base,
                                                              const number<Backend, ExpressionTemplates> &exp,
                                                              const number<Backend, ExpressionTemplates> &mod) {
            return number<Backend, ExpressionTemplates>(eval_power_mod(base.backend(), exp.backend(), mod.backend()));
        }
    }
}
