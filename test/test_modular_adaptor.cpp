...
#include <chrono>
#include <boost/multiprecision/tommath/modular_params_tommath.hpp>
...
//   tom_int baset = 2234234234234;
//   tom_int expt("34534534534532342342342344534524");
//   tom_int exp_1t = expt + 1;
//   tom_int modt = 25234234234234;
//   tom_int_mod base_mt(baset, modt);
//   tom_int_mod exp_mt(expt, exp_1t);

   auto t1 = std::chrono::high_resolution_clock::now();
   std::cout << powm(base, exp, mod) << std::endl;
   auto t2 = std::chrono::high_resolution_clock::now();
   std::cout << pow(base_m, exp_m) << std::endl;
