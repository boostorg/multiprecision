...
int main()
{
   using quad_float_of_double_type = boost::multiprecision::number<boost::multiprecision::backends::cpp_quad_float<double>>;
   using quad_float_of_ldbl_type = boost::multiprecision::number<boost::multiprecision::backends::cpp_quad_float<long double>>;
#ifdef BOOST_MATH_USE_FLOAT128
