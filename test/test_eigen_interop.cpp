...
#define BOOST_MP_EIGEN_SCALAR_TRAITS_DECL(A)\
   ...
   template<class Backend, boost::multiprecision::expression_template_option ExpressionTemplates, typename BinaryOp>
   struct ScalarBinaryOpTraits<boost::multiprecision::number<Backend, ExpressionTemplates>, typename NumTraits<typename internal::enable_if<NumTraits<boost::multiprecision::number<Backend, ExpressionTemplates> >::IsComplex, boost::multiprecision::number<Backend, ExpressionTemplates> >::type>::Real, BinaryOp>
   {
      typedef boost::multiprecision::number<Backend, ExpressionTemplates> ReturnType;
   }; 

   template<class Backend, boost::multiprecision::expression_template_option ExpressionTemplates, typename BinaryOp>
   struct ScalarBinaryOpTraits<typename NumTraits<typename internal::enable_if<NumTraits<boost::multiprecision::number<Backend, ExpressionTemplates> >::IsComplex, boost::multiprecision::number<Backend, ExpressionTemplates> >::type>::Real, boost::multiprecision::number<Backend, ExpressionTemplates>, BinaryOp>
   {
      typedef boost::multiprecision::number<Backend, ExpressionTemplates> ReturnType;
   }; 
...
void example22()
{
   ...
   double relative_error = static_cast<double>(abs((A*x - b).norm() / b.norm())); // norm() is L2 norm
